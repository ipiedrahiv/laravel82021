...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="{{ route('home.index') }}">@lang('seed.home')</a>
                <a class="navbar-brand js-scroll-trigger" href="{{ route('seed.list') }}">@lang('seed.store')</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    @guest
                        ...
                        @else
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{ route('seed.list') }}">@lang('seed.store')</a></li>
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{ route('order.index') }}">Order</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">@lang('seed.matilda')</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">@lang('seed.website')</p>
            </div>
        </header>
